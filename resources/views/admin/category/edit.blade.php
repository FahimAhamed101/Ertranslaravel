                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            @if (!empty($category->image))
                                <div class="col-md-6">
                                    <img width="200" src="{{asset('uploads/category/thumbnail/'.$category->image)}}" alt="">
                                </div>
                            @else
                            <div class="col-md-6">
                                <img width="200" src="{{asset('admin-assets/img/no-image.png')}}" alt="">
                            </div>
                            @endif
...
@section('customJs')
    <script>
        $('#categoryForm').submit(function(event) {
            ...
            $.ajax({
                url: '{{ route('categort.update', $category->id) }}',
                type: 'put',
