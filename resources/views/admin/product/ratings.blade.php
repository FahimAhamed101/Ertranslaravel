                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            @if (count($product_ratings) > 0)
                                @foreach ($product_ratings as $rating)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($rating->status == 1)
                                                <a href="javascript:void(0);" onclick="statusChange(0, '{{ $rating->id }}');">
                                            ...
                                            @else
                                                <a href="javascript:void(0)" onclick="statusChange(1, '{{ $rating->id }}')">
                                        ...
                                        <td>
                                            <a href="{{ route('product.edit', $rating->id) }}">
                            ...
                            @else
                                <tr>
                                    <td>
                                        <p class="text-danger">Records not Found</p>
                                    </td>
                                </tr>
                            @endif
        ...
        function statusChange(status, id) {
            if (confirm("Are You Sure Want to change status")) {
                $.ajax({
                    ...
                    success: function(response) {
                        window.location.href = "{{ route('product.changeRatingStatus') }}";
                    }
                });
            }
        }
